...
function autocompletionFact() {
    ...
    xhr.onload = function() {
        ...
        list.innerHTML = '';
        console.log(list);
        this.response.forEach(obj => { // для каждого введенного символа выводится список подсказок
...
function autocompletionFactEvent(event) { // нажимаем на подсказку и она записывается в поле ввода
